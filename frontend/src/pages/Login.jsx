    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-chart-2 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white mb-2">Maintenance Board</h1>
          <p className="text-primary-foreground/80 text-lg">Streamline your maintenance operations</p>
        </div>
        ...
        <div className="relative z-10 text-primary-foreground/60 text-sm">
          © 2025 Ajitesh Dwivedi. All rights reserved.
        </div>
      </div>
